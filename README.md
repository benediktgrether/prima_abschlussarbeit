...
|  1 | Nutzerinteraktion     | Der Nutzer kann mittels A nach links laufen und mit D nach rechts. Mittels Leertaste kann er Springen und mit Festhalten der Entertaste Kämpfen. Mit der Taste E kann das aktuelle Item gedropped werden. Zusätzlich kann der Nutzer im Laufenden mit M das Spiel Muten/Unmuten und er kann bei Spielstart über den Knopf Mute das Spiel direkt bei Start muten * A - nach links laufen * D - nach rechts laufen * Space - Springen * Enter - Kämpfen * E - Item Drop * M - Mute 
|
